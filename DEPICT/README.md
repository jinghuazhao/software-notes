...
```
where we opt to customise the header rather than the DEPICT configuration file. Moreover, the (hg19) chromosomal positions are *eventually* added to the data which would facilitate GCTA-COJO analysis which mirrors [SUMSTATS](https://github.com/jinghuazhao/SUMSTATS).
