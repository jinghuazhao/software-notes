...
## bamtools, bcftools, bedtools, blast (ncbi-blast+), bowtie2, fastqc, fastx-toolkit, hmmer, hisat2, picard-tools, rsem, sambamba, samtools, seqtk, sra-toolkit, tophat, vcftools (Ubuntu archive)
