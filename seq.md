...
## Ubuntu archive (bamtools, bcftools, bedtools, blast (ncbi-blast+), fastqc, fastx-toolkit, hmmer, hisat2, picard-tools, rsem, sambamba, samtools, seqtk, sra-toolkit, tophat, vcftools)
